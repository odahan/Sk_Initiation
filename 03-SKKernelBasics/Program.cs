...
// Plugin C# natif
kernel.ImportPluginFromObject(new OutilsDate(), "outil");

// SK > version 1.0 ne supporte plus l'appel en string "outil.jour"
var function = kernel.Plugins["outil"]["jour"];

var result = await kernel.InvokeAsync(function);

var fcolor = Console.ForegroundColor;
Console.ForegroundColor = ConsoleColor.Green;
Console.WriteLine($"Aujourd'hui, c'est : {result}");
