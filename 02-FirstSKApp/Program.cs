...
builder.AddOpenAIChatCompletion("gpt-3.5-turbo-1106", apiKey!); // ici gpt-4 est 20x +cher pour rien...
var kernel = builder.Build();

Console.WriteLine("----Interrogation de l'IA avec Semantic Kernel et .NET----");
var consoleColor = Console.ForegroundColor;
Console.ForegroundColor = ConsoleColor.Green;
var result = await kernel.InvokePromptAsync(
    "Donne-moi 3 raisons d’utiliser Semantic Kernel avec .NET");

Console.WriteLine(result);
Console.ForegroundColor = consoleColor;
Console.WriteLine("----FIN du programme de test----");