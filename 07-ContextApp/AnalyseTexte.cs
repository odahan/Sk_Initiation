...
{
    [KernelFunction("countCharacters")]
    public int CompterCaractères(string input)
        => input.Length;

    [KernelFunction("estimateLength")]
    public string EvaluerLongueur(int charCount, int threshold)
    {
